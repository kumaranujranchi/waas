    ...
    <div class="max-w-[1200px] mx-auto">
        ...
        <div class="mb-12">
            ...
            <p class="text-[#545095] dark:text-gray-400">
                <?php echo isAdmin() ? 'Here is what\'s happening with your business today.' : 'Manage your subscriptions and account settings'; ?>
            </p>
        </div>
        ...
        <?php if (isAdmin()): ?>
            ...
            $recentGlobalOrders = $orderModel->getRecentOrders(5);
            ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                ...
                <div class="bg-white dark:bg-white/5 rounded-xl p-6 border border-[#e8e8f3] dark:border-white/10">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="material-symbols-outlined text-4xl text-purple-600">group</span>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-12">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-bold text-[#0f0e1b] dark:text-white">Recent Orders</h2>
                    <a href="<?php echo baseUrl('admin/orders/list.php'); ?>"
                        class="text-primary hover:underline font-medium">View All</a>
                </div>

                <?php if (empty($recentGlobalOrders)): ?>
                    <div
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-white/10">
                                    <?php foreach ($recentGlobalOrders as $order): ?>
                                        <tr>
                                            <td class="px-6 py-4 text-sm font-medium">
                                                <?php echo e($order['order_number']); ?>
                                            </td>
                                            <td class="px-6 py-4 text-sm">
                                                <div class="font-medium"><?php echo e($order['user_name']); ?></div>
                                            </td>
                                            <td class="px-6 py-4 text-sm">
        ...
        <?php else: ?>
            <!-- User Dashboard (Original Content) -->
            <?php
            // Get user specific data (Moved inside else block to avoid unnecessary queries for admin if they don't need it, 
            // but for now keeping the queries at top is fine, here we just display)
            ?>
