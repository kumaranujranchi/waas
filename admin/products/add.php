...
<main class="flex-1 bg-background-light dark:bg-background-dark min-h-screen py-8 px-6">
    <div class="max-w-[1000px] mx-auto">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h1 class="text-3xl font-black text-[#0f0e1b] dark:text-white">Add New Solution</h1>
                <p class="text-[#545095] dark:text-gray-400">Create a comprehensive product listing with pricing and
                    FAQs</p>
            </div>
        </div>
