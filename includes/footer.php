        ...
        <div
            ...
            <div class="flex flex-col md:flex-row items-center gap-6">
                ...
                <div class="flex items-center gap-3 opacity-90 transition-all">
                    <!-- Visa -->
                    <svg class="h-4 w-auto" viewBox="0 0 32 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M12.936 0.165039L8.724 9.87104H4.568L1.604 2.80904C1.258 1.48104 0.246 0.999039 0 0.851039L0.05 0.630039H4.726C5.358 0.630039 5.922 1.05604 6.066 1.77804L7.198 7.85404L10.038 1.78204C10.608 0.564039 10.596 0.165039 9.864 0.165039H12.936ZM24.462 6.78404C24.478 4.24604 20.898 4.09904 20.938 2.94904C20.952 2.60004 21.284 2.23504 22.128 2.12504C22.562 2.07204 23.75 2.01604 25.132 2.63704L25.61 0.496039C24.966 0.270039 24.136 0.165039 23.116 0.165039C20.254 0.165039 18.238 1.66604 18.23 3.86804C18.22 5.48504 19.678 6.38804 20.768 6.91404C21.884 7.45204 22.258 7.79404 22.256 8.32404C22.25 9.15004 21.282 9.53104 20.378 9.53104C19.348 9.53104 18.272 9.24604 17.59 8.94004L17.158 11.082C17.808 11.376 19.028 11.625 20.282 11.642C23.27 11.642 25.228 10.176 25.244 7.93504L24.462 6.78404ZM31.624 0.334039H28.98C28.168 0.334039 27.502 0.568039 27.2 1.28404L23.336 10.468C23.758 10.468 25.32 10.468 25.864 10.468C26.062 9.58904 26.262 9.28204 26.758 9.28204H29.746C29.832 9.61904 30.016 10.468 30.016 10.468H32.61L31.624 0.334039ZM27.484 7.82804C27.674 7.15204 28.324 4.54204 28.324 4.54204C28.298 4.59004 28.694 5.92204 28.878 6.64904C28.932 6.85804 29.074 7.55004 29.074 7.55004L28.618 7.82804H27.484ZM17.652 0.334039L15.352 11.524H12.986L15.286 0.334039H17.652Z"
                            fill="#1434CB" />
                    </svg>

                    <!-- Mastercard -->
                    <svg class="h-5 w-auto" viewBox="0 0 38 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="12" cy="12" r="12" fill="#EB001B" fill-opacity="0.9" />
                        <circle cx="26" cy="12" r="12" fill="#F79E1B" fill-opacity="0.9" />
                    </svg>

                    <!-- Amex -->
                    <svg class="h-5 w-auto rounded" viewBox="0 0 36 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="36" height="24" fill="#006FCF" />
                        <path
                            d="M22.02 5.06H25.04L26.15 7.64L27.27 5.06H29.98L27.45 10.51L27.46 10.51L29.74 15.11H27.09L26.19 13.06L25.26 15.11H22.45L24.81 10.51L22.02 5.06ZM12.01 5.06V15.11H14.86V9.41H16.63L18.44 14.86L20.24 9.4H21.73V15.11H24.38V5.06H21.46L18.42 13.23L15.37 5.06H12.01ZM8.6 12.35L7.23 8.87L5.85 12.36H8.6ZM3.51 5.06L7.33 15.11H10.15L8.73 11.51H5.73L4.31 15.11H1.54L5.35 5.06H3.51Z"
                            fill="white" />
                    </svg>

                    <!-- PayPal -->
                    <svg class="h-4 w-auto" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M18.845 5.253C18.243 4.548 17.26 4.093 16.037 4.093H9.411C9.074 4.093 8.783 4.331 8.732 4.664L6.924 16.142C6.903 16.275 7.006 16.395 7.141 16.395H10.222L9.822 18.932C9.771 19.265 10.029 19.558 10.366 19.558H14.129C14.42 19.558 14.673 19.349 14.717 19.062L14.793 18.577L15.201 15.989C15.228 15.82 15.374 15.696 15.545 15.696H15.972C18.667 15.696 20.812 14.606 21.217 10.873C21.393 9.255 20.931 7.697 18.845 5.253Z"
                            fill="#003087" />
                        <path
                            d="M18.303 5.76C17.771 5.138 16.903 4.737 15.824 4.737H9.258C8.921 4.737 8.63 4.975 8.579 5.308L6.829 16.425C6.808 16.558 6.911 16.678 7.046 16.678H9.313L9.697 14.238C9.748 13.905 10.039 13.667 10.376 13.667H11.834C15.845 13.667 17.971 12.049 18.574 8.225C18.729 7.236 18.796 6.335 18.303 5.76Z"
                            fill="#009cde" />
                        <path
                            d="M9.697 14.238L8.277 16.425C8.256 16.558 8.359 16.678 8.494 16.678H11.575L11.175 19.215C11.124 19.548 11.382 19.841 11.719 19.841H15.482C15.773 19.841 16.026 19.632 16.07 19.345L16.146 18.86L16.554 16.272C16.581 16.103 16.727 15.979 16.898 15.979H17.325C20.02 15.979 21.6 14.939 21.986 12.018C22.072 11.378 22.094 10.835 22.052 10.395C21.372 13.119 18.966 14.238 15.178 14.238H10.376C10.039 14.238 9.748 14.05 9.697 14.238Z"
                            fill="#012169" />
                    </svg>
                    <div
