        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12">
            ...
            <div>
                ...
                <ul class="flex flex-col gap-4 text-sm text-[#545095] dark:text-white/60">
                    ...
                    <li><a class="hover:text-primary" href="<?php echo baseUrl('index.php#solutions'); ?>">Pricing</a>
                    </li>
        ...
        <div
            ...
            <div class="flex flex-col md:flex-row items-center gap-6">
                ...
                <div class="flex items-center gap-3 opacity-90 transition-all">
                    <!-- Visa -->
                    <img src="<?php echo baseUrl('assets/banklogo/Visa_Inc._logo.svg'); ?>" alt="Visa"
                        class="h-4 w-auto object-contain">

                    <!-- Mastercard -->
                    <img src="<?php echo baseUrl('assets/banklogo/MasterCard_early_1990s_logo.svg'); ?>"
